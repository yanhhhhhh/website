...
export const metadata: Metadata = {
  title: 'HeroEE',
  description: 'HiTHIUM HeroEE portable power station, 省钱•安全•耐用的家庭储能系统 | HiTHIUM HeroEE 户外移动电源,省钱•安全•耐用的家庭储能系统',
  keywords:[
    'Hithium',
    'HiTHIUM',
    'HeroEE',
    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="https://hero.hithium.com/intro/logo100.jpg"
        />
        <meta
