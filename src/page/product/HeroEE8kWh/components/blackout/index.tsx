...
import { HeroEE8kWhBlackout } from '@/constants/production/HeroEE8kWh';
...
export const Blackout = () => {
  const { title, description, images } = HeroEE8kWhBlackout;
  ...
  return (
    <AnimationView
      {...animationViewProps}
      children={
        <div className={`heroEE8kWh-blackout-feature-wrapper ${languageCode}`}>
          {HeroEE8kWhBlackout.features.map((feature) => (
